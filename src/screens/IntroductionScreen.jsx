  ...
  template () {
    return (
      ...
      >
        <Eyes />
        <Particles
          {...Config.PARTICLES.presets.introduction}
          innerRadiusX={22}
          innerRadiusY={15}
          outerWidth={80}
          outerHeight={70}
          entering={$(this.$step, step => step >= 1)}
        />

        <Caption
          position='bottom'
          text={$(this.$step, step => widont(I18N(`introduction.${step}`, { rounds: Config.SESSION.rounds }, null)))}

...
export default class Eyes extends Component {
    ...
    return (
      <section class='eyes'>
        <svg viewBox='0 0 170 83' fill='none' xmlns='http://www.w3.org/2000/svg'>
          <mask id='mask0_410_4348' style='mask-type:alpha' maskUnits='userSpaceOnUse' x='1' y='0' width='168' height='83'>
          ...
          <g mask='url(#mask0_410_4348)'>
            <mask id='mask1_410_4348' style='mask-type:alpha' maskUnits='userSpaceOnUse' x='0' y='0' width='171' height='120'>
            ...
            <g id='blanc' mask='url(#mask1_410_4348)'>
  ...
  #updatePupil = direction => {
    this.refs.pupil.classList.toggle('is-left', direction === -1)
    this.refs.pupil.classList.toggle('is-right', direction === 1)
  }
}
